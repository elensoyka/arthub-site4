...
const lots = [
  ...
  },
  {
    ...
    "text": "Размещение ваших работ в пространстве ArtHub на один месяц. Для экспозиции предоставляется участок стены площадью 1,5 м².",
    "meta": [
      "1 месяц",
      "1,5 м²"
    ],
    ...
    "details": [
      ...
      "работы размещаются на участке стены площадью 1,5 м²."
    ]
  },
  {
    "category": "Проводить",
